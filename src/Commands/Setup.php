<?php
namespace Tualo\Office\QRCodeJS\Commands;
use Garden\Cli\Cli;
use Garden\Cli\Args;
...
class Setup extends BaseSetup implements ISetupCommandline{
    ...
    public static function getCommandName(): string { return 'qrcodejs'; }
    public static function getCommandDescription(): string { return 'perform a complete qrcodejs setup'; }
    ...
    public static function run(Args $args) { 
        ...
        PostCheck::formatPrintLn(['blue'], "Installing all needed SQL procedures for qrcodejs module");
